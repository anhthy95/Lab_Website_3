...
app.get('/team_stats', function(req, res) {
  var q_games = 'select * from football_games;';
  var q_wins = 'select count(*) as num from football_games where home_score > visitor_score;';
  var q_losses = 'select count(*) as num from football_games where visitor_score > home_score;';
...
app.get('/player_info', function(req, res) {
  var q_players = 'select id, name from football_players;';
  db.any(q_players)
  .then(function(rows) {
...
app.get('/player_info/select_player', function(req, res) {
  var q_players = 'select id, name from football_players;';
  var q_player_info = 'select * from football_players where id=' + req.query.player_choice + ';';
  var q_games_played = 'SELECT COUNT(*) AS num FROM (SELECT id FROM football_players, football_games ' +
  ...
  db.task('get-everything', task => {
    return task.batch([
      task.any(q_players),
      task.any(q_player_info),
      task.any(q_games_played)
    ]);
  })
  .then(info => {
    res.render('pages/player_info', {
